...
public class AbpFluentValidationModule : AbpModule
{
    public override void PreInitialize()
    {
        ...
        IocManager.Register<
            AbpFluentValidationLanguageManager,
            AbpFluentValidationLanguageManager
        >();
        IocManager.Register<IValidatorFactory, AbpFluentValidationValidatorFactory>(
    ...
    public override void PostInitialize()
    {
        ValidatorOptions.Global.LanguageManager =
            IocManager.Resolve<AbpFluentValidationLanguageManager>();
    }
}
