...
public class AbpUserConfigurationBuilder : ITransientDependency
{
    ...
    protected virtual AbpUserLocalizationConfigDto GetUserLocalizationConfig()
    {
        ...
        config.Sources = sources
            .Select(s => new AbpLocalizationSourceDto { Name = s.Name, Type = s.GetType().Name })
            .ToList();
    ...
    {
        return new AbpUserClockConfigDto { Provider = Clock.Provider.GetType().Name.ToCamelCase() };
    }
