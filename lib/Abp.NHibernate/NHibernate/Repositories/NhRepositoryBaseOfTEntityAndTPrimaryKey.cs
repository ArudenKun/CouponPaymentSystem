...
public abstract class NhRepositoryBase<TEntity, TPrimaryKey>
    : AbpRepositoryBase<TEntity, TPrimaryKey>,
        IRepositoryWithSession
    where TEntity : class, IEntity<TPrimaryKey>
{
    ...
    public virtual Task<ISession> GetSessionAsync()
    {
        return Task.FromResult(_sessionProvider.Session);
    }
