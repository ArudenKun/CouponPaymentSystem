...
public class AbpWebApiModule : AbpModule
{
    ...
    public override void PostInitialize()
    {
        ...
        foreach (var controllerInfo in IocManager.Resolve<DynamicApiControllerManager>().GetAll())
        {
            IocManager.IocContainer.Register(
                ...
                Component
                    .For(controllerInfo.ApiControllerType)
            ...
            LogHelper.Logger.DebugFormat(
                ...
                controllerInfo.ServiceInterfaceType.FullName,
    ...
    private void InitializeAspNetServices(HttpConfiguration httpConfiguration)
    {
        httpConfiguration.Services.Replace(
            ...
            new AbpHttpControllerSelector(
                httpConfiguration,
                IocManager.Resolve<DynamicApiControllerManager>()
            )
        );
        httpConfiguration.Services.Replace(
        ...
        httpConfiguration.Services.Replace(
            typeof(IApiExplorer),
            IocManager.Resolve<AbpApiExplorer>()
        );
    }
    ...
    private static void InitializeFormatters(HttpConfiguration httpConfiguration)
    {
        ...
        foreach (var currentFormatter in httpConfiguration.Formatters.ToList())
        {
            if (
                !(
                    currentFormatter is JsonMediaTypeFormatter
