...
public class ResultWrapperHandler : DelegatingHandler, ITransientDependency
{
    ...
    protected virtual void WrapResultIfNeeded(
        HttpRequestMessage request,
    ...
    )
    {
        ...
        if (
            _abpWebCommonModuleConfiguration.WrapResultFilters.HasFilterForWrapOnSuccess(
                absolutePath,
        ...
        var wrapAttr =
            HttpActionDescriptorHelper.GetWrapResultAttributeOrNull(request.GetActionDescriptor())
