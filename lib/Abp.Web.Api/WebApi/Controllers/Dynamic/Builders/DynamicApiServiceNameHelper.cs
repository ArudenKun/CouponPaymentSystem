...
{
    private static readonly Regex ServiceNameRegex = new Regex(
        @"^([a-zA-Z_][a-zA-Z0-9_]*)(\/([a-zA-Z_][a-zA-Z0-9_]*))+$"
    );
    private static readonly Regex ServiceNameWithActionRegex = new Regex(
    ...
    {
        return serviceNameWithAction.Substring(
            0,
            serviceNameWithAction.LastIndexOf("/", StringComparison.InvariantCultureIgnoreCase)
        );
    }
    ...
    {
        return serviceNameWithAction.Substring(
            serviceNameWithAction.LastIndexOf("/", StringComparison.InvariantCultureIgnoreCase) + 1
        );
    }
}
