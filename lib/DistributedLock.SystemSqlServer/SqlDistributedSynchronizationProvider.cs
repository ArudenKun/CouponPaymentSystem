        ...
        IDistributedSemaphoreProvider
{
    ...
    /// </summary>
    public SqlDistributedSynchronizationProvider(
    ...
    )
    {
        ...
        this._lockFactory = (name, exactName) =>
            new SqlDistributedLock(name, connectionString, options, exactName);
        this._readerWriterLockFactory = (name, exactName) =>
            new SqlDistributedReaderWriterLock(name, connectionString, options, exactName);
        this._semaphoreFactory = (name, maxCount) =>
            new SqlDistributedSemaphore(name, maxCount, connectionString, options);
    }
    ...
    public SqlDistributedSynchronizationProvider(IDbConnection connection)
    {
        ...
        this._lockFactory = (name, exactName) =>
            new SqlDistributedLock(name, connection, exactName);
        this._readerWriterLockFactory = (name, exactName) =>
            new SqlDistributedReaderWriterLock(name, connection, exactName);
        this._semaphoreFactory = (name, maxCount) =>
            new SqlDistributedSemaphore(name, maxCount, connection);
    }
    ...
    public SqlDistributedSynchronizationProvider(IDbTransaction transaction)
    {
        ...
        this._lockFactory = (name, exactName) =>
            new SqlDistributedLock(name, transaction, exactName);
        this._readerWriterLockFactory = (name, exactName) =>
            new SqlDistributedReaderWriterLock(name, transaction, exactName);
        this._semaphoreFactory = (name, maxCount) =>
            new SqlDistributedSemaphore(name, maxCount, transaction);
    }
    ...
    /// </summary>
    public SqlDistributedLock CreateLock(string name, bool exactName = false) =>
        this._lockFactory(name, exactName);
    ...
    /// is specified, invalid applock names will be escaped/hashed.
    /// </summary>
    public SqlDistributedReaderWriterLock CreateReaderWriterLock(
        string name,
        bool exactName = false
    ) => this._readerWriterLockFactory(name, exactName);

    IDistributedUpgradeableReaderWriterLock IDistributedUpgradeableReaderWriterLockProvider.CreateUpgradeableReaderWriterLock(
        string name
    ) => this.CreateReaderWriterLock(name);

    IDistributedReaderWriterLock IDistributedReaderWriterLockProvider.CreateReaderWriterLock(
        string name
    ) => this.CreateReaderWriterLock(name);
    ...
    IDistributedSemaphore IDistributedSemaphoreProvider.CreateSemaphore(
        string name,
        int maxCount
