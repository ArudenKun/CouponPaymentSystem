...
public class DapperActionFilterExecuter : IDapperActionFilterExecuter, ITransientDependency
{
    ...
    {
        _iocResolver
            .Resolve<CreationAuditDapperActionFilter>()
            .ExecuteFilter<TEntity, TPrimaryKey>(entity);
    }
    ...
    {
        _iocResolver
            .Resolve<ModificationAuditDapperActionFilter>()
            .ExecuteFilter<TEntity, TPrimaryKey>(entity);
    }
    ...
    {
        _iocResolver
            .Resolve<DeletionAuditDapperActionFilter>()
            .ExecuteFilter<TEntity, TPrimaryKey>(entity);
    }
}
