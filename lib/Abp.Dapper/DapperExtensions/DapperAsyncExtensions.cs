...
public static class DapperAsyncExtensions
{
    ...
    public static Func<IDapperExtensionsConfiguration, IDapperAsyncImplementor> InstanceFactory
    {
        get
        {
            return _instanceFactory ??= config => new DapperAsyncImplementor(
                new SqlGeneratorImpl(_configuration)
            );
        }
        set
        {
            ...
            Configure(
                _configuration.DefaultMapper,
                _configuration.MappingAssemblies,
                _configuration.Dialect
            );
        }
    }
    ...
    /// </summary>
    public static IDapperExtensionsConfiguration Configure(
        this IDapperExtensionsConfiguration configuration
    )
    {
        _instance = null;
    ...
    {
        return Configure(
            new DapperExtensionsConfiguration(defaultMapper, mappingAssemblies, sqlDialect)
        );
    }
    ...
    )
    {
        return await Instance
            .CountAsync<T>(connection, predicate, transaction, commandTimeout)
    ...
    {
        return await Instance
            .GetAsync<T>(connection, id, transaction, commandTimeout, buffered, null)
            .ConfigureAwait(false);
    }
    ...
    /// Executes a query for the specified id, returning the data typed as per T.
    /// </summary>
    public static async Task<TOut> GetPartialAsync<TIn, TOut>(
        this IDbConnection connection,
        dynamic id,
        ...
        where TOut : class
    {
        ...
        TIn obj = await Instance
            .GetAsync<TIn>(connection, id, transaction, commandTimeout, buffered, cols)
            .ConfigureAwait(false);
    ...
    /// </summary>
    public static async Task<IEnumerable<T>> GetListAsync<T>(
        this IDbConnection connection,
        object predicate = null,
    ...
    /// </summary>
    public static async Task<IEnumerable<TOut>> GetPartialListAsync<TIn, TOut>(
        this IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate = null,
        IList<ISort> sort = null,
        ...
        where TOut : class
    {
        var cols = GetBufferedCols<TOut>();
        List<TIn> list = (
            await Instance.GetListAsync<TIn>(
                connection,
                predicate,
                sort,
                transaction,
    ...
    /// </summary>
    public static async Task<IEnumerable<T>> GetListAutoMapAsync<T>(
        this IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        IDbTransaction transaction = null,
    ...
    /// Executes an update query for the specified entity.
    /// </summary>
    public static Task<bool> UpdatePartialAsync<TIn, TOut>(
        this IDbConnection connection,
        TIn entity,
        IDbTransaction transaction = null,
        int? commandTimeout = null,
    ...
    /// </summary>
    public static async Task<IEnumerable<T>> GetPageAsync<T>(
        this IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        int page = 1,
    ...
    /// Data returned is dependent upon the specified page and resultsPerPage.
    /// </summary>
    public static async Task<IEnumerable<TOut>> GetPartialPageAsync<TIn, TOut>(
        this IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate = null,
        IList<ISort> sort = null,
        ...
        where TOut : class
    {
        ...
        List<TIn> list = (
            await Instance.GetPageAsync<TIn>(
                connection,
                predicate,
                sort,
                page,
    ...
    /// Contains Slapper.Automaper
    /// </summary>
    public static async Task<IEnumerable<T>> GetPageAutoMapAsync<T>(
        this IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        int page = 1,
    ...
    /// </summary>
    public static async Task<IEnumerable<T>> GetSetAsync<T>(
        this IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        int firstResult = 1,
    ...
    /// Data returned is dependent upon the specified firstResult and maxResults.
    /// </summary>
    public static async Task<IEnumerable<TOut>> GetPartialSetAsync<TIn, TOut>(
        this IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate = null,
        IList<ISort> sort = null,
        ...
        where TOut : class
    {
        ...
        List<TIn> list = (
            await Instance.GetSetAsync<TIn>(
                connection,
                predicate,
                sort,
                firstResult,
