...
public class VirtualPredicate : IVirtualPredicate
{
    ...
    public VirtualPredicate()
        : base() { }

    public VirtualPredicate(string comparable, Operator op, object value, bool not = false)
        : base()
    {
    ...
    )
    {
        ...
        var valueParameter = parameters.SetParameterName(
            param,
