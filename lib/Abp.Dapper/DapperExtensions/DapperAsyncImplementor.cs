...
public interface IDapperAsyncImplementor : IDapperImplementor
{
    ...
    /// </summary>
    Task<IEnumerable<T>> GetListAutoMapAsync<T>(
        IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        IDbTransaction transaction = null,
    ...
    /// </summary>
    Task<IEnumerable<T>> GetPageAutoMapAsync<T>(
        IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        int page = 1,
    ...
    /// </summary>
    Task<IEnumerable<T>> GetSetAsync<T>(
        IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        int firstResult = 1,
    ...
    Task<bool> UpdateAsync<T>(
        ...
        IList<IProjection> colsToUpdate = null
    );
    ...
    Task<IMultipleResultReader> GetMultipleAsync(
        IDbConnection connection,
...
public class DapperAsyncImplementor : DapperImplementor, IDapperAsyncImplementor
{
    ...
    /// The asynchronous counterpart to <see cref="IDapperImplementor.Insert{T}(IDbConnection, T, IDbTransaction, int?)"/>.
    /// </summary>
    public async Task<dynamic> InsertAsync<T>(
        IDbConnection connection,
        T entity,
        IDbTransaction transaction,
        int? commandTimeout
    )
    {
        ...
        return await InternalInsertAsync(
            connection,
            entity,
            transaction,
            commandTimeout,
    ...
    {
        return await InternalUpdateAsync(
            connection,
            entity,
            transaction,
            colsToUpdate,
    ...
    {
        return await InternalGetListAutoMapAsync<T>(
            connection,
            predicate,
            sort,
            transaction,
    ...
    public async Task<IEnumerable<T>> GetListAutoMapAsync<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        IDbTransaction transaction,
    ...
    {
        return await InternalGetPageAutoMapAsync<T>(
            connection,
            predicate,
            sort,
            page,
    ...
    /// The asynchronous counterpart to <see cref="IDapperImplementor.GetPageAutoMap{T}"/>.
    /// </summary>
    public async Task<IEnumerable<T>> GetPageAutoMapAsync<T>(
        IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        int page = 1,
    ...
    {
        return await InternalGetSetAsync<T>(
            connection,
            predicate,
            sort,
            firstResult,
    ...
    {
        return await Task.FromResult(
            Count<T>(connection, predicate, transaction, commandTimeout, includedProperties)
        );
    }
    ...
    private async Task<dynamic> InternalInsertAsync<T>(
        IDbConnection connection,
        T entity,
        IDbTransaction transaction,
        int? commandTimeout,
    ...
    private async Task<bool> InternalUpdateAsync<T>(
        IDbConnection connection,
        T entity,
        IClassMapper classMap,
    ...
    private async void InternalUpdateAsync<T>(
        IDbConnection connection,
        IEnumerable<T> entities,
        IDbTransaction transaction,
        IList<IProjection> cols,
    ...
    private async Task<T> InternalGetAsync<T>(
        IDbConnection connection,
        dynamic id,
        IDbTransaction transaction,
        int? commandTimeout,
    ...
    private async Task<IEnumerable<T>> InternalGetListAutoMapAsync<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        IDbTransaction transaction,
    ...
    private async Task<IEnumerable<T>> InternalGetPageAutoMapAsync<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        int page,
    ...
    private async Task<IEnumerable<T>> InternalGetSetAsync<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        int firstResult,
    ...
    )
    {
        ...
        return await connection
            .QueryAsync<T>(sql, dynamicParameters, transaction, commandTimeout, CommandType.Text)
            .ConfigureAwait(false);
    }

    protected async Task<IEnumerable<T>> GetListAutoMapAsync<T>(
        IDbConnection connection,
        IClassMapper classMap,
        IPredicate predicate,
        IList<ISort> sort,
    ...
    {
        var query = await GetListAsync<dynamic>(
            connection,
            classMap,
            predicate,
            sort,
    ...
    /// The asynchronous counterpart to <see cref="IDapperImplementor.GetPage{T}"/>.
    /// </summary>
    protected async Task<IEnumerable<T>> GetPageAutoMapAsync<T>(
        IDbConnection connection,
        IClassMapper classMap,
        IPredicate predicate,
        IList<ISort> sort,
    ...
    {
        var query = await GetPageAsync<dynamic>(
            connection,
            classMap,
            predicate,
            sort,
