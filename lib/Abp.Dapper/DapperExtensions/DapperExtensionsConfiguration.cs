...
{
    private readonly ConcurrentDictionary<Type, SqlInjection> _sqlInjections =
        new ConcurrentDictionary<Type, SqlInjection>();
            ...
            return (
                ...
                where
                    ...
                    && (
                        ...
                        || interfaceType.GetGenericArguments()[0] == entityType?.BaseType
                    )
