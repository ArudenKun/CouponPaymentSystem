...
public static class DapperExtensions
{
    ...
    public static Func<IDapperExtensionsConfiguration, IDapperImplementor> InstanceFactory
    {
        get
        {
            return _instanceFactory ??= config => new DapperImplementor(
                new SqlGeneratorImpl(config)
            );
        }
        set
        {
    ...
    public static SqlInjection GetOrSetSqlInjection(
    ...
    /// Executes a query for the specified id, returning the data typed as per T
    /// </summary>
    public static TOut GetPartial<TIn, TOut>(
        this IDbConnection connection,
        dynamic id,
    ...
    /// </summary>
    public static dynamic Insert<T>(
        this IDbConnection connection,
        T entity,
        IDbTransaction transaction = null,
        int? commandTimeout = null
    ...
    /// </summary>
    public static bool UpdatePartial<TIn, TOut>(
        this IDbConnection connection,
        TIn entity,
        Expression<Func<TIn, TOut>> func,
        IDbTransaction transaction = null,
    ...
    /// Executes some column an update query for the specified entity, as typed by LINq expresion
    /// </summary>
    public static void UpdatePartial<TIn, TOut>(
        this IDbConnection connection,
    ...
    /// </summary>
    public static IEnumerable<TOut> GetPartialList<TIn, TOut>(
        this IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate = null,
        IList<ISort> sort = null,
        ...
        where TIn : class
    {
        return Instance.GetPartialList(
            connection,
            func,
            predicate,
            sort,
    ...
    /// </summary>
    public static IEnumerable<T> GetListAutoMap<T>(
        this IDbConnection connection,
        object predicate = null,
        IList<ISort> sort = null,
        IDbTransaction transaction = null,
    ...
    {
        return Instance.GetListAutoMap<T>(
            connection,
            predicate,
            sort,
            transaction,
    ...
    /// Executes a select query using the specified predicate, returning an IEnumerable data typed as per T with relacionated classes.
    /// </summary>
    public static IEnumerable<TOut> GetPartialListAutoMap<TIn, TOut>(
        this IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate = null,
        IList<ISort> sort = null,
        ...
        where TIn : class
    {
        return Instance.GetPartialListAutoMap(
            connection,
            func,
            predicate,
            sort,
    ...
    /// Data returned is dependent upon the specified page and resultsPerPage.
    /// </summary>
    public static IEnumerable<TOut> GetPartialPage<TIn, TOut>(
        this IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
        ...
        where TOut : class
    {
        return Instance.GetPartialPage(
            connection,
            func,
            predicate,
            sort,
    ...
    public static IEnumerable<T> GetPageAutoMap<T>(
        this IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        int page,
    ...
    {
        return Instance.GetPageAutoMap<T>(
            connection,
            predicate,
            sort,
            page,
    ...
    /// Data returned is dependent upon the specified page and resultsPerPage.
    /// </summary>
    public static IEnumerable<TOut> GetPartialPageAutoMap<TIn, TOut>(
        this IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
        ...
        where TOut : class
    {
        return Instance.GetPartialPageAutoMap(
            connection,
            func,
            predicate,
            sort,
    ...
    /// </summary>
    public static IEnumerable<T> GetSet<T>(
        this IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        int firstResult,
    ...
    /// Data returned is dependent upon the specified firstResult and maxResults.
    /// </summary>
    public static IEnumerable<TOut> GetPartialSet<TIn, TOut>(
        this IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
    ...
    /// </summary>
    public static IMultipleResultReader GetMultiple(
        this IDbConnection connection,
    ...
    public static IList<Assembly> MappingAssemblies
    {
        get => _configuration.MappingAssemblies;
    }
    ...
    public static IEnumerable<IMemberMap> GetIdentifiers(this IClassMapper map)
    {
        ...
        {
            var refs = DapperExtensions
                .GetMap(table.EntityType)
                .Properties.Where(c =>
                    c.ClassMapper.Identity == table.Identity
                    && (
