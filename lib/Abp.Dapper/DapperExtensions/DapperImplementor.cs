...
namespace Abp.Dapper.DapperExtensions;
...
public interface IDapperImplementor
{
    ...
    TOut GetPartial<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        dynamic id,
        IDbTransaction transaction,
        int? commandTimeout,
        IList<IReferenceMap> includedProperties = null
    ...
    IEnumerable<TOut> GetPartialList<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
        ...
        where TIn : class;
    IEnumerable<T> GetListAutoMap<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        IDbTransaction transaction,
    ...
    IEnumerable<TOut> GetPartialListAutoMap<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
    ...
    IEnumerable<TOut> GetPartialPage<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
        ...
        where TIn : class
        where TOut : class;
    IEnumerable<T> GetPageAutoMap<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        int page,
    ...
    IEnumerable<TOut> GetPartialPageAutoMap<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
    ...
    IEnumerable<TOut> GetPartialSet<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
    ...
    IMultipleResultReader GetMultiple(
        IDbConnection connection,
...
{
    private static readonly Dictionary<Type, IList<IProjection>> ColsBuffer =
        new Dictionary<Type, IList<IProjection>>();
    ...
    {
        return (T)
            InternalGet<T>(connection, id, transaction, commandTimeout, null, includedProperties);
    }

    public TOut GetPartial<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        dynamic id,
        IDbTransaction transaction,
    ...
    )
    {
        ...
        var nonIdentityKeyProperties = classMap
            .Properties.Where(p => p.KeyType == KeyType.Guid || p.KeyType == KeyType.Assigned)
            .ToList();
        var identityColumn = classMap.Properties.SingleOrDefault(p =>
            p.KeyType == KeyType.Identity
        );
        var triggerIdentityColumn = classMap.Properties.SingleOrDefault(p =>
        ...
        foreach (var e in entities)
            InternalInsert(
                ...
                commandTimeout,
                classMap,
                nonIdentityKeyProperties,
                identityColumn,
                triggerIdentityColumn,
                sequenceIdentityColumn
            );
    }

    public dynamic Insert<T>(
        IDbConnection connection,
        T entity,
        IDbTransaction transaction,
        int? commandTimeout
    ...
    public bool UpdatePartial<TIn, TOut>(
        IDbConnection connection,
        TIn entity,
        Expression<Func<TIn, TOut>> func,
        IDbTransaction transaction,
    ...
    public void UpdatePartial<TIn, TOut>(
        IDbConnection connection,
        IEnumerable<TIn> entities,
        Expression<Func<TIn, TOut>> func,
        IDbTransaction transaction,
    ...
    public IEnumerable<TOut> GetPartialList<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        ...
        where TIn : class
    {
        return GetPartialListAutoMap<TIn, TOut>(
            connection,
            func,
            predicate,
            sort,
    ...
    public IEnumerable<T> GetListAutoMap<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        IDbTransaction transaction,
    ...
    {
        return InternalGetListAutoMap<T>(
            connection,
            predicate,
            sort,
            transaction,
    ...
    public IEnumerable<TOut> GetPartialListAutoMap<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
    ...
    {
        var cols = GetBufferedCols<TOut>();
        var te = InternalGetListAutoMap<TIn>(
                connection,
                predicate,
                sort,
                transaction,
    ...
    public IEnumerable<TOut> GetPartialPage<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
        ...
        where TOut : class
    {
        return GetPartialPageAutoMap<TIn, TOut>(
            connection,
            func,
            predicate,
            sort,
    ...
    public IEnumerable<T> GetPageAutoMap<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        int page,
    ...
    {
        return InternalGetPageAutoMap<T>(
            connection,
            predicate,
            sort,
            page,
    ...
    public IEnumerable<TOut> GetPartialPageAutoMap<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
    ...
    {
        var cols = GetBufferedCols<TOut>();
        var te = InternalGetPageAutoMap<TIn>(
                connection,
                predicate,
                sort,
                page,
    ...
    public IEnumerable<TOut> GetPartialSet<TIn, TOut>(
        IDbConnection connection,
        Expression<Func<TIn, TOut>> func,
        object predicate,
        IList<ISort> sort,
    ...
    )
    {
        ...
        return (int)
            connection
                .Query(sql, dynamicParameters, transaction, false, commandTimeout, CommandType.Text)
                .Single()
                .Total;
    }

    public IMultipleResultReader GetMultiple(
        IDbConnection connection,
        GetMultiplePredicate predicate,
        IDbTransaction transaction,
        int? commandTimeout,
    ...
    protected IEnumerable<T> GetListAutoMap<T>(
        IDbConnection connection,
        IList<IProjection> colsToSelect,
        IClassMapper classMap,
        IPredicate predicate,
    ...
    protected IEnumerable<T> GetPageAutoMap<T>(
        IDbConnection connection,
        IClassMapper classMap,
        IPredicate predicate,
        IList<ISort> sort,
    ...
    {
        var parameters = new Dictionary<string, object>();
        var sql = SqlGenerator.SelectPaged(
            classMap,
            predicate,
            sort,
            page,
    ...
    protected IEnumerable<T> GetPage<T>(
        IDbConnection connection,
        IClassMapper classMap,
        IPredicate predicate,
        IList<ISort> sort,
    ...
    protected IEnumerable<T> GetSet<T>(
        IDbConnection connection,
        IClassMapper classMap,
        IPredicate predicate,
        IList<ISort> sort,
    ...
    {
        var parameters = new Dictionary<string, object>();
        var sql = SqlGenerator.SelectSet(
            classMap,
            predicate,
            sort,
            firstResult,
    ...
    {
        var whereFields = classMap.Properties.Where(p =>
            p.KeyType != KeyType.NotAKey && p.KeyType != KeyType.ForeignKey
        );
        if (!whereFields.Any())
        {
    ...
    protected static IPredicate GetEntityPredicate(IClassMapper classMap, object entity)
    {
        ...
        foreach (
            var kvp in DapperExtensionsReflectionHelper
                .GetObjectValues(entity)
    ...
    protected GridReaderResultReader GetMultipleByBatch(
        IDbConnection connection,
        GetMultiplePredicate predicate,
        IDbTransaction transaction,
        int? commandTimeout,
    ...
    )
    {
        ...
        foreach (var item in predicate.Items)
        {
            ...
            _ = sql.Append(
                ...
                .AppendLine(SqlGenerator.Configuration.Dialect.BatchSeperator);
        }
    ...
    )
    {
        ...
        foreach (var item in predicate.Items)
        {
            ...
            var queryResult = connection.QueryMultiple(
                sql,
                dynamicParameters,
                transaction,
                commandTimeout,
    ...
    protected void SetAutoMapperIdentifier(IList<Table> tables)
    {
        foreach (var table in tables)
        {
            ...
            AutoMapper.Configuration.AddIdentifiers(
                table.IsVirtual ? table.EntityType.BaseType : table.EntityType,
                properties
            );
        }
    }
    ...
    {
        if (
            SqlGenerator.AllColumns.Any(c =>
                c.SimpleAlias.Equals(simpleAlias, StringComparison.InvariantCultureIgnoreCase)
            )
        )
            return SqlGenerator
                .AllColumns.Where(c =>
    ...
    protected string GetSimpleAliasFromColumnAlias(string columnAlias)
    {
        if (
            SqlGenerator.AllColumns.Any(c =>
                c.Alias.Equals(columnAlias, StringComparison.InvariantCultureIgnoreCase)
            )
        )
            return SqlGenerator
                .AllColumns.Where(c =>
    ...
    protected virtual DynamicParameters AddParameter<T>(
        T entity,
    ...
    )
    {
        ...
        var parameter = DapperExtensionsReflectionHelper.GetParameter(
            typeof(T),
            SqlGenerator,
            prop.Name,
            propValue
    ...
    private DynamicParameters GetDynamicParameters<T>(
        T entity,
        IClassMapper classMap,
        IList<IMemberMap> sequenceColumn,
        IList<MemberInfo> foreignKeys,
        IList<MemberInfo> ignoredColumns,
        bool useColumnAlias
    )
    {
        var keyColumns =
            sequenceColumn.Count == 0
                ? classMap
                    .Properties.Where(p =>
                        p.KeyType == KeyType.Assigned || p.KeyType == KeyType.Guid
                    )
                    ?.ToList()
                : sequenceColumn;
        ...
        foreach (
            var prop in entity
                ...
                .Where(p =>
                    !keyColumns.Any(k => k.Name.Equals(p.Name))
                    && !foreignKeys.Contains(p)
                    && !ignoredColumns.Contains(p)
                )
        )
    ...
    public DynamicParameters GetDynamicParameters<T>(
        IClassMapper classMap,
        T entity,
        bool useColumnAlias = false
    )
    {
        var sequenceIdentityColumn = classMap
            .Properties.Where(p => p.KeyType == KeyType.SequenceIdentity)
            ?.ToList();
        var foreignKeys = classMap
            .Properties.Where(p => p.KeyType == KeyType.ForeignKey)
            .Select(p => p.MemberInfo)
            .ToList();
    ...
    private object InsertTriggered<T>(
        IDbConnection connection,
        T entity,
        IDbTransaction transaction,
        int? commandTimeout,
    ...
    )
    {
        ...
        return dynamicParameters.Get<object>(
            SqlGenerator.Configuration.Dialect.ParameterPrefix + "IdOutParam"
        );
    }

    private object InsertIdentity<IdentityType>(
        IDbConnection connection,
        IDbTransaction transaction,
        int? commandTimeout,
        IClassMapper classMap,
    ...
    )
    {
        ...
        if (SqlGenerator.SupportsMultipleStatements())
        {
            sql +=
                ...
                + SqlGenerator.IdentitySql(classMap);
            result = connection.Query<IdentityType>(
                sql,
                dynamicParameters,
                transaction,
                false,
    ...
    private IDictionary<string, object> AddSequenceParameter<T>(
        IDbConnection connection,
        T entity,
        IMemberMap key,
        DynamicParameters dynamicParameters,
    ...
    private void AddKeyParameters<T>(
        T entity,
        IList<IMemberMap> keyList,
        DynamicParameters dynamicParameters,
        bool useColumnAlias = false
    )
    {
    ...
    protected dynamic InternalInsert<T>(
        IDbConnection connection,
        T entity,
        IDbTransaction transaction,
        int? commandTimeout,
        IClassMapper classMap,
        IList<IMemberMap> nonIdentityKeyProperties,
        IMemberMap identityColumn,
        IMemberMap triggerIdentityColumn,
        IList<IMemberMap> sequenceIdentityColumn
    )
    {
        ...
        if (triggerIdentityColumn != null || identityColumn != null)
        {
            ...
            {
                keyValue = InsertIdentityByKeyMemberType(
                    keyColumn.MemberType,
                    connection,
                    transaction,
                    commandTimeout,
                    classMap,
    ...
    private object InsertIdentityByKeyMemberType(
        Type keyColumnMemberType,
        IDbConnection connection,
        IDbTransaction transaction,
        int? commandTimeout,
        IClassMapper classMap,
    ...
    protected bool InternalUpdate<T>(
        IDbConnection connection,
        T entity,
        IClassMapper classMap,
        IPredicate predicate,
        IDbTransaction transaction,
        IList<IProjection> cols,
        int? commandTimeout,
        bool ignoreAllKeyProperties = false
    )
    {
        var parameters = new Dictionary<string, object>();
        string sql = SqlGenerator.Update(
            classMap,
            predicate,
            parameters,
            ignoreAllKeyProperties,
    ...
    protected void InternalUpdate<T>(
        IDbConnection connection,
        IEnumerable<T> entities,
        IDbTransaction transaction,
        IList<IProjection> cols,
    ...
    protected IEnumerable<T> InternalGetListAutoMap<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        IDbTransaction transaction,
    ...
    protected IEnumerable<T> InternalGetPageAutoMap<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        int page,
    ...
    protected IEnumerable<T> InternalGetSet<T>(
        IDbConnection connection,
        object predicate,
        IList<ISort> sort,
        int firstResult,
    ...
    protected bool InternalDelete<T>(
        IDbConnection connection,
        T entity,
        IDbTransaction transaction,
        int? commandTimeout
    ...
    protected virtual void GetMapAndPredicate<T>(
        object predicateValue,
        out IClassMapper classMapper,
        out IPredicate wherePredicate,
        bool keyPredicate = false
    )
    {
