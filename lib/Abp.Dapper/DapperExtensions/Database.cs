...
public interface IAsyncDatabase : IBaseDatabase
{
    ...
    Task<IMultipleResultReader> GetMultiple(
        GetMultiplePredicate predicate,
        IDbTransaction transaction,
        int? commandTimeout = null
    );
...
public class Database : BaseDatabase, IDatabase
{
    ...
    public virtual IEnumerable<T> GetList<T>(
        object predicate,
        IList<ISort> sort,
        IDbTransaction transaction,
        int? commandTimeout,
    ...
    public virtual IEnumerable<T> GetPage<T>(
        object predicate,
        IList<ISort> sort,
        int page,
        int resultsPerPage,
    ...
    public virtual IEnumerable<T> GetSet<T>(
        object predicate,
        IList<ISort> sort,
        int firstResult,
        int maxResults,
    ...
    public virtual IMultipleResultReader GetMultiple(
        GetMultiplePredicate predicate,
        IDbTransaction transaction,
        int? commandTimeout
    )
...
public class AsyncDatabase : BaseDatabase, IAsyncDatabase
{
    ...
    public virtual async Task<T> Get<T>(dynamic id, IDbTransaction transaction, int? commandTimeout)
    {
        return await _dapper.GetAsync<T>(Connection, id, transaction, commandTimeout);
    }

    public virtual async Task<T> Get<T>(dynamic id, int? commandTimeout)
    {
        return await _dapper.GetAsync<T>(Connection, id, _transaction, commandTimeout);
    }

    public virtual async void Insert<T>(
        IEnumerable<T> entities,
        IDbTransaction transaction,
        int? commandTimeout
    )
    ...
    public virtual async void Insert<T>(IEnumerable<T> entities, int? commandTimeout)
    {
        await _dapper.InsertAsync(Connection, entities, _transaction, commandTimeout);
    }

    public virtual async Task<dynamic> Insert<T>(
        T entity,
        IDbTransaction transaction,
        int? commandTimeout
    )
    ...
    public virtual async Task<dynamic> Insert<T>(T entity, int? commandTimeout)
    {
    ...
    {
        return await _dapper.UpdateAsync(
            Connection,
            entity,
            transaction,
            commandTimeout,
    ...
    public virtual async Task<bool> Delete<T>(
        T entity,
        IDbTransaction transaction,
        int? commandTimeout
    )
    ...
    public virtual async Task<bool> Delete<T>(T entity, int? commandTimeout)
    {
    ...
    public virtual async Task<bool> Delete<T>(object predicate, int? commandTimeout)
    {
        return await _dapper.DeleteAsync<T>(Connection, predicate, _transaction, commandTimeout);
    }

    public virtual async Task<IEnumerable<T>> GetList<T>(
        object predicate,
        IList<ISort> sort,
        IDbTransaction transaction,
        int? commandTimeout,
    ...
    {
        return await _dapper.GetListAsync<T>(
            Connection,
            predicate,
            sort,
            transaction,
    ...
    public virtual async Task<IEnumerable<T>> GetPage<T>(
        object predicate,
        IList<ISort> sort,
        int page,
        int resultsPerPage,
    ...
    {
        return await _dapper.GetPageAsync<T>(
            Connection,
            predicate,
            sort,
            page,
    ...
    public virtual async Task<IEnumerable<T>> GetSet<T>(
        object predicate,
        IList<ISort> sort,
        int firstResult,
        int maxResults,
    ...
    {
        return await _dapper.GetSetAsync<T>(
            Connection,
            predicate,
            sort,
            firstResult,
    ...
    public virtual async Task<int> Count<T>(object predicate, int? commandTimeout)
    {
        return await _dapper.CountAsync<T>(Connection, predicate, _transaction, commandTimeout);
    }

    public virtual async Task<IMultipleResultReader> GetMultiple(
        GetMultiplePredicate predicate,
        IDbTransaction transaction,
        int? commandTimeout
    )
    ...
    public virtual async Task<Guid> GetNextGuid()
    {
        return await Task.FromResult(_dapper.SqlGenerator.Configuration.GetNextGuid());
    }

    public virtual async Task<IClassMapper> GetMap<T>()
    {
