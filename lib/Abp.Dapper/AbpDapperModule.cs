...
public class AbpDapperModule : AbpModule
{
    public override void PreInitialize()
    {
        ...
        Slapper.AutoMapper.Configuration.TypeConverters.Add(
            new AutoMapper.Configuration.EnumConverter()
        );
    }
    ...
    public override void Initialize()
    {
        ...
        {
            ISecondaryOrmRegistrar[] additionalOrmRegistrars =
                scope.ResolveAll<ISecondaryOrmRegistrar>();
